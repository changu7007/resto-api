...
export const REDIS_URL =
  ENV === "development" ? process.env.REDIS_URL : process.env.PROD_REDIS_URL;
...
export const RAZORPAY_KEY_ID =
  ENV === "development"
    ...
    : (process.env.PROD_RAZORPAY_KEY_ID as string);
export const RAZORPAY_KEY_SECRET =
  ENV === "development"
    ? (process.env.RAZORPAY_KEY_SECRET as string)
    : (process.env.PROD_RAZORPAY_KEY_SECRET as string);
